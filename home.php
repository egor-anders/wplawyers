...
<section class="introduction">
  <div class="container">
    <div class="small-container">
      <p class="introduction__question">Вас пытаются привлечь к субсидиарной ответственности и выставили иск на
        сумму <span>более 5 млн. рублей?</span></p>
      <h1 class="introduction__title">Оценим перспективы вашего дела, построим стратегию защиты и представим ваши
        интересы в суде</h1>
    </div>
    <div class="info">
      <div class="small-container">
        <div class="info__wrapper">
          ...
          <div class="info__right">
            <h2 class="info__title">С 2010 года мы участвовали в 450+ делах и <br>выиграли 430 судебных споров.
              Самый крупный — на 1.2 млрд. руб</h2>
            <ul class="info__list list-reset">
              <li class="info__item">
                <p class="info__text">Защищаем основателей,<br>акционеров, бывших директоров,<br>членов СД,
                  бухгалтеров и др.</p>
              </li>
              <li class="info__item info__item--2">
                <p class="info__text"><span>Денис Куликов</span><br>Основатель компании<br>Адвокат</p>
              </li>
            </ul>
          </div>
        </div>
        <div class="info__consultation">
          <p class="info__text info__text--big"><span>Получите консультацию</span> в оспаривании иска,<br>даже
            если суд в первой инстанции принял<br>решение не в вашу пользу</p>
          <form action="#" class="form">
            <div class="form__buttons"><label class="form__label"><input type="text" name="Имя"
                  class="input-reset form__input" placeholder="+7 (999) 999 99 99" data-phone-mask required> <svg
                  class="form__icon">
                  <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#phone"></use>
                </svg></label> <button class="btn-reset form__btn"><span>Получить консультацию</span></button>
            </div>
          </form>
          <div class="info__links">
            <p class="info__message">Или напишите в удобный мессенджер</p>
            <div class="links"><a href="#" class="links__link links__link--whatsapp"><svg class="links__icon">
                  <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#whatsapp"></use>
                </svg> </a><a href="#" class="links__link links__link--telegram"><svg class="links__icon">
...
<main>
  ...
  <section class="owner">
    <div class="container owner__wrapper">
      <div class="small-container">
        <h2 class="owner__title title">Мы уже участвовали в сотнях заседаний по арбитражным спорам и
        ...
        <div class="owner__content">
          <div class="owner__quote"><img src="<?php bloginfo('template_url'); ?>/assets/img/quote.svg" alt=""
            ...
            <p class="owner__text owner__text--big owner__text--tablet">Перед тем, как взяться за дело, мы глубоко
              изучаем все тонкости, детально оцениваем риски и прорабатываем алгоритм решения задачи. Поэтому <b>в 9
                из 10 случаев мы получаем предсказуемый результат даже в сложных ситуациях, которые, казалось<br>бы,
                уже проигрышные</b></p>
            <p class="owner__text owner__text--small">Поэтому в 9 из 10 случаев мы получаем предсказуемый результат
          ...
          <div class="owner__info">
            <div class="owner__item owner__item--1">
              ...
              <p class="owner__descr">Основатель компании Адвокат</p>
            ...
            <div class="owner__item owner__item--2">
              <h3 class="owner__counter">400+</h3>
              <p class="owner__descr owner__descr--2">Помог <span>выиграть более 400 дел</span> по субсидиарной
                ответсвенности</p>
            </div>
          </div>
        </div>
  ...
  <section class="protection">
    <div class="container">
      <div class="small-container">
        <h2 class="protection__title title">Умеем строить защиту по субсидиарным спорам, <span>независимо от суммы
            требований</span> и масштабов проблемы</h2>
        <div class="protection__list">
          <div class="protection__left">
            <div class="protection__info protection__info--tablet">
              <p class="protection__text protection__text--info">Даже если на вас пытаются завести уголовное дело
  ...
  <section class="cases">
    <div class="container">
      <div class="small-container">
        <h2 class="cases__title">За 13 лет <span>помогли выиграть больше 450 дел.</span> Самое большее —
          <b>на 1.2 млрд. руб.</b>
        </h2>
        ...
        <ul class="cases__list list-reset">
          <li class="cases__item"><a href="<?php bloginfo('template_url'); ?>/assets/img/case.png"
            ...
            <div class="cases__content">
              <h4 class="cases__name">Защитили клиента от личной субсидиарной ответственности на 1 126 780 000 руб.
              </h4>
              <p class="cases__descr">Решение суда № АА-3414-954 от 01.04.2019 г.</p>
              <p class="cases__text">Клиент работал директором в компании в период с 2007 по 2014 год. <b>В 2015
                  году компания была продана и должность занял другой человек.</b> Спустя 5 лет компания подала
                на банкротство, но оказалось что при процессе продажи, клиент <b>подписал несколько лишних
                  бумажек.</b><br><br><b>В результате ему пытались присудить долг в 126 млн. руб, который скопился
                  за последние 5 лет. Мы оспорили документы и отменили иск</b></p>
              <p class="cases__result"><span>Результат:</span> Суд полностью отказал в иске</p><button
                class="btn-reset cases__button btn" onclick="togglePopup('form1');" data-graph-path=""><span>Получить
                  консультацию по моему делу</span></button>
  ...
  <section class="work">
    <div class="container">
      <div class="small-container">
        <h2 class="work__title title"><b>«Под ключ» решаем все вопросы,</b> связанные с подготовкой документов
          и ведением дела</h2>
        ...
        <ul class="list-reset work__list">
          ...
          <li class="work__item"><img src="<?php bloginfo('template_url'); ?>/assets/img/work/decision.png" alt=""
            ...
            <p class="work__text">Получаем документы и переходим в апелляционную инстанцию. Находим слабые места,
              которые позволят отменить решение суда</p>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="help">
    <div class="container help__wrapper">
      <div class="small-container">
        <h2 class="help__title">Узнайте, <b>как избежать ошибок и проблем</b> в вашем споре</h2>
        <div class="help__container">
          <div class="help__left">
            <p class="help__call">Обратитесь за помощью специалистов компании и получите <b>бесплатную консультацию
                эксперта по арбитражным спорам</b></p>
            <form action="#" class="form help__form">
              <p class="help__text"><b>Укажите телефон,</b><br>мы уточним детали вашей ситуации, дадим оценку
                и расскажем, как вам разрешить спор в свою пользу.<br><span>Это 100% бесплатно</span></p>
              <div class="form__buttons help__buttons"><label class="form__label"><input type="text" name="Имя"
                    class="input-reset form__input" placeholder="+7 (999) 999 99 99" data-phone-mask required> <svg
                    class="form__icon">
                    <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#phone"></use>
                  </svg></label> <button class="btn-reset form__btn"><span>Получить консультацию</span></button>
            ...
            <div class="help__links">
              <p class="help__message">Или напишите в удобный мессенджер</p>
              <div class="links"><a href="#" class="links__link links__link--whatsapp"><svg class="links__icon">
                    <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#whatsapp"></use>
                  </svg> </a><a href="#" class="links__link links__link--telegram"><svg class="links__icon">
                    <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#telegram"></use>
          ...
          <div class="help__right">
            <h3 class="help__subtitle">Денис<br>Куликов</h3>
            <p class="help__descr help__descr--bold">Основатель компании<br>Адвокат</p>
            <div class="help__item">
              <h3 class="help__counter">400+</h3>
              <p class="help__descr help__descr--counter">Помог <b>выиграть больше 400 дел</b> по субсидиарной
                ответсвенности</p>
            </div>
          </div>
        </div>
  ...
  <section class="mistake">
    <div class="container">
      <div class="small-container mistake__wrapper">
        <h2 class="mistake__title title">Попытка самостоятельного разрешения спора <span>может привести
            к провалу</span> еще на этапе подготовки</h2>
        <p class="mistake__explanation">Из-за ошибок, допущенных на этапе досудебного урегулирования<br>и подготовки
          иска.</p>
        <div class="mistake__attention">
          <p class="mistake__text">Зачастую эти ошибки навсегда <span>исключают возможность разрешения спора в вашу
              пользу</span></p>
      ...
      <div class="small-container meeting__wrapper">
        ...
        <div class="meeting__content">
          ...
          <div class="meeting__services">
            ...
            <div class="btn-reset btn meeting__btn" onclick="togglePopup('form3');">Назначить встречу с юристом
            </div>
          </div>
          <div class="btn-reset btn meeting__btn meeting__btn--tablet" onclick="togglePopup('form3');">Назначить
            встречу с юристом</div>
        </div>
      </div>
    </div>
  </section>
          ...
          <ul class="list-reset methods__list">
            ...
            <li class="methods__item"><img src="<?php bloginfo('template_url'); ?>/assets/img/methods/third.png" alt=""
              ...
              <p class="methods__descr m-reset">Когда мы приносим коробки документов в суд, юристы оппонента
                начинают смеяться, но как только они начинают изучать документы, то смех куда-то пропадает</p>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container company__wrapper">
      <div class="small-container company__container">
        <div class="company__left">
          <h2 class="title company__title">«Столичная<br>юридическая компания»</h2>
          <p class="company__descr m-reset">Юридическая компания, которая специализируется на арбитражных делах и
            спорах о субсидиарной ответственности <b>с 2010 года</b><br><br><b>Сотни выигранных дел с участием
              государственных компаний, банков, корпораций с миллиардными оборотами</b> дали нам бесценный опыт,
            который сегодня очень нужен предпринимателям</p>
        ...
        <div class="company__right">
          <form action="#" class="form company__form">
            ...
            <div class="form__buttons"><label class="form__label company__label"><input type="text" name="Имя"
                  class="input-reset form__input company__input" placeholder="+7 (999) 999 99 99" data-phone-mask
                  required> <svg class="form__icon company__icon">
                  <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#phone"></use>
                </svg></label> <button class="btn-reset form__btn company__btn"><span>Отправить
                  запрос</span></button></div>
          </form>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="small-container">
        <div class="question__container">
          <h2 class="title question__title">Не нашли ответ на свой вопрос?</h2>
          <p class="question__descr m-reset">Задайте его лично адвокату</p>
          <div class="question__wrapper">
            <form action="#" class="form question__form">
              ...
              <div class="form__buttons"><label class="form__label question__label"><input type="text" name="Имя"
                    class="input-reset form__input question__input" placeholder="+7 (999) 999 99 99" data-phone-mask
                    required> <svg class="form__icon question__icon">
                    <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#phone"></use>
                  </svg></label> <button class="btn-reset form__btn question__btn"><span>Отправить вопрос
